      ...
      <motion.div initial="hidden" animate="visible" variants={fadeRight}>
        <div className='AboutPage'>
          <div className='AboutText'>
            ...
            <p>
              Mon parcours m'a permis de maîtriser des langages tels que <b>HTML, CSS, TS, C#, PHP et MySQL,</b> et je suis également familier avec la technologie moderne telle que <b>React et Angular.</b> Mon expérience s'étend également à l'utilisation de <b>Sass</b> pour améliorer le style de mes projets.
              <br /><br />
